		...
		switch (item){
			...
			case "File":
				...
				if (fileTab.isFileListEmpty(driver)){
					...
					fileTab.uploadFile(driver, "/Users/linawalaa/Downloads/IMG_2709.PNG");
//					fileTab.uploadFile(driver, "/Users/linawalaa/Downloads/ninjaripper171.7z");
				}
				break;
...
//		resultPage.goToHomePage();
	...
	public void uploadSmallFile(){
		...
		assertEquals("nd-term-invoice.pdf", fileTab.viewFirstFileName(driver));
	}
	...
	public void uploadBigFile(){
		...
		//click on the file tab and upload a file size > 200MB (not acceptable)
		fileTab.uploadFile(driver, "/Users/linawalaa/Downloads/ideaIU-2021.2.1.dmg");

		//assert that the error msg is displayed because file is > 200MB
